...
const PILLARS = [
  {
    ...
    eyebrow: "01",
    title: "Games",
    body: "Android games in Unity — from 60-second hyper-casual titles to mid-core experiences with live events and seasonal content. Built, published, and operated entirely by us.",
    href: "/games",
    cta: "Browse games",
  },
  {
    ...
    eyebrow: "02",
    title: "Web3",
    body: "Decentralised apps, on-chain games, and NFT marketplaces across EVM-compatible chains and Solana. We write the contracts, build the frontend, and own the outcome.",
    href: "/web3",
    cta: "See Web3 work",
  },
  {
    ...
    eyebrow: "03",
    title: "Apps",
    body: "Mobile utilities and consumer apps built around one rule: if we wouldn't use it ourselves, we don't ship it. No dark patterns, no engagement traps.",
    href: "/apps",
    cta: "Explore apps",
  },
];
